...
export function Home() {
  return (
    <div className="home flex flex-col w-full h-full p-4">
      <div className="home-opcions flex flex-row w-full h-full p-2">
        <div className="flex flex-row justify-center items-center space-x-1 cursor-pointer">
          <SiExercism className="size-5" />
          <p>Follow</p>
        </div>
        <div className="flex flex-row justify-center items-center ml-7 space-x-1 cursor-pointer">
