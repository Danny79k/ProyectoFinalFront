...
function Header() {
  ...
  return (
    <div className={isDarkMode ? "dark" : "white"}>
      <header
        className={`flex w-screen items-center justify-between  h-[7vh] ${
          isDarkMode ? "text-white bg-black" : "text-black bg-slate-100"
        }`}
      >
        <NavLink to="/" className="flex items-center ml-5">
        <img src={img} alt="Tele M" className="size-24 ml-5" />
        </NavLink>
        <button
          className={`absolute right-4  ${
            menuOpen ? "rotate-y-hidden" : "rotate-y"
          }`}
          onClick={toggleMenu}
        >
          <svg
        ...
        <button
          className={`absolute right-4 ${
            menuOpen ? "rotate-y" : "rotate-y-hidden"
          }`}
          onClick={toggleMenu}
        >
          <svg
      ...
      >
        <ul
          className={`w-full px-4 py-4 space-y-1 divide-y ${
            isDarkMode ? "divide-white" : "divide-black"
          }`}
        >
          ...
          <li className="text-lg py-2">
            ...
            <div>
              <ul
                className={`text-sm  ml-5 mt-2 space-y-1 ${
          ...
          <li className="pt-4 flex text-lg">
        ...
        <div className="flex mt-auto">
          <ul className="flex flex-col w-full px-4 py-4 items-center mb-10">
            <li
              className={`text-sm w-full text-center mb-4 bg-gray-900 rounded-2xl border-gray-600 border ${
                isDarkMode ? "text-white" : "text-black bg-slate-300"
              }`}
            >
            ...
            <li
              className={`text-sm  bg-gray-900 w-full text-center rounded-2xl border-gray-600 border ${
                isDarkMode ? "text-white" : "text-black bg-slate-300"
              }`}
            >
